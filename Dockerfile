...
# Install all gem groups - development deps (puma, devise, propshaft…) are
# runtime requirements for the dummy app.
COPY Gemfile Gemfile.lock layered-resource-rails.gemspec ./
COPY lib/layered/resource/version.rb lib/layered/resource/version.rb
ENV BUNDLE_WITHOUT=""
RUN bundle install && \
